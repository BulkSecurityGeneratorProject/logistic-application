package io.logistic.application.repository;

import io.logistic.application.JogisticApplicationApp;
import io.logistic.application.config.Constants;
import io.logistic.application.config.audit.AuditEventConverter;
import io.logistic.application.domain.PersistentAuditEvent;
...
import static io.logistic.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
